...
<div class="block">
    <div class="header">
        ...
        <div class="side pull-right">
            <ul class="buttons">
                <li><a href="/area/address/add_city"><span class="icon-plus"></span> Tambah Data </a></li>
            </ul>
        </div>
    </div>
    <div class="content">
...
<script>
    $(document).ready(function () {
        var table = $('#tbl_city').DataTable({
            processing : true,
            ajax: {
                url: '<?php echo base_url()?>area/city/getCity',
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, full) {
                        return '<a href="<?php echo base_url()?>area/address/edit_city/' + full.id + '" class=" editor_edit"><span class="icon-edit"></span></a> | <a href="#" class=" editor_remove" onclick="showModalRemove(\'' + full.name + '\',\'' + full.id + '\')"><span class="icon-trash"></span></a>';
                    }
                }
            ],
            buttons: [
    ...
    function hapus(id) {
        ...
        $.ajax({
            type: "POST",
            url: "<?PHP echo base_url()?>area/city/deleteCity",
            data: dataSend,
