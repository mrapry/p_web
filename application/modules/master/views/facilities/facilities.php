    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-danger">
                ...
                <h4 class="modal-title">Hapus Sarana</h4>
            </div>
            <div class="modal-body">
                <p>Apakah anda setuju menghapus Sarana<br><br><strong><b id="datafacilities"></b></strong></p>
            </div>
...
<script>
    ...
    function showModalRemove(facilities, id) {
        $("#datafacilities").html(facilities);
    ...
    function hapus(id) {
        ...
        $.ajax({
            type: "POST",
            url: "/master/facilities/deleteFacilities",
            data:dataSend,
