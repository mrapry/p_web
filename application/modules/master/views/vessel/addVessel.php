            ...
            <div class="col-md-12">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <button class="btn btn-default pull-right" type="button" onclick="window.location = '<?php echo base_url()?>master/vessel/vassel'">Kembali</button>
                    </div>
                </form>
            </div>
        </div>
